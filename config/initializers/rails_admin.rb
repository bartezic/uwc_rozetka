# RailsAdmin config file. Generated on March 30, 2013 21:56
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rozetka', 'Admin']
  ...
  # config.excluded_models = ['Photo', 'Product']

  # Include specific models (exclude the others):
  # config.included_models = ['Photo', 'Product']
